...
<body>
    <div class="card">
        ...
        <h1>Crear cuenta</h1>
        <p class="subtitle">Crea tu cuenta de jugador. Al registrarte se activará también tu billetera inicial.</p>
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="hint">Mínimo 8 caracteres, una mayúscula, una minúscula y un número.</div>
