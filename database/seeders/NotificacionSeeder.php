...
class NotificacionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('notificaciones')->insert([
            ...
            ['user_id' => $users['mateo@bookie20.test'], 'tipo' => 'apuesta', 'titulo' => 'Dados perdidos', 'mensaje' => 'Tu apuesta a alto perdió porque salió un 2.', 'leido' => false, 'fecha' => $now->copy()->subDays(9), 'created_at' => $now, 'updated_at' => $now],
            ['user_id' => $users['sofia@bookie20.test'], 'tipo' => 'apuesta', 'titulo' => 'Cara o cruz ganada', 'mensaje' => 'Acertaste cara y se abonó tu ganancia.', 'leido' => false, 'fecha' => $now->copy()->subDays(8), 'created_at' => $now, 'updated_at' => $now],
            ...
            ['user_id' => $users['daniel@bookie20.test'], 'tipo' => 'apuesta', 'titulo' => 'Cara o cruz perdida', 'mensaje' => 'Salió cara y tu apuesta a cruz fue perdida.', 'leido' => false, 'fecha' => $now->copy()->subHours(5), 'created_at' => $now, 'updated_at' => $now],
        ]);
    }
}
